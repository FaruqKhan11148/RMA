...
function DeliveryOrders() {
      ...
      async (position) => {
        ...
        try {
          const response = await fetch(
            'http://localhost:5000api/delivery/location',
            {
              method: 'POST',
              headers: {
  ...
  const handleRequestOtp = async () => {
    ...
    try {
      ...
      const response = await fetch(
        'http://localhost:5000api/delivery/request-otp',
        {
          method: 'POST',
  ...
  const handleVerifyLoginOtp = async () => {
    ...
    try {
      ...
      const response = await fetch(
        'http://localhost:5000api/delivery/verify-otp',
        {
          method: 'POST',
  ...
  useEffect(() => {
    ...
    const fetchDeliveryOrders = async () => {
      try {
        ...
        const response = await fetch(
          'http://localhost:5000api/delivery/orders',
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
  ...
  useEffect(() => {
    const fetchRoute = async () => {
      try {
        ...
        const response = await fetch(
          `http://localhost:5000api/delivery/route/${order.orderId}`,
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
